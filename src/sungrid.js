...
import { solarPosition, solarNoonUtcMs } from './solar.js?v=10'; // ?v= must match app.js — see cache-busting note there
import { skylineLayersForPoint, inLeaf } from './scene.js?v=10';
