...
import { solarPosition, solarNoonUtcMs } from './solar.js?v=12'; // ?v= must match app.js — see cache-busting note there
import { skylineLayersForPoint, inLeaf } from './scene.js?v=12';
